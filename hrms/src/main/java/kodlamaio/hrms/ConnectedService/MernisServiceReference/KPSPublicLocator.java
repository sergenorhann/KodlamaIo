...
package kodlamaio.hrms.ConnectedService.MernisServiceReference;
...
public class KPSPublicLocator extends org.apache.axis.client.Service implements kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublic {
    ...
    public kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoapStub _stub = new kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoapStub _stub = new kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
