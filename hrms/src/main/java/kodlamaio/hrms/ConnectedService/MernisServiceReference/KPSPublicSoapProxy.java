...
public class KPSPublicSoapProxy implements kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoap {
  private String _endpoint = null;
  private kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public kodlamaio.hrms.ConnectedService.MernisServiceReference.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
